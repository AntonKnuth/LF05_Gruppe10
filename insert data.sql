...
INSERT
IGNORE INTO ADRESSE (strasse, hausnummer, adresszusatz, ort_id)
VALUES ('Hauptstrasse', '12', '', 1),
       ('Musterweg', '34A', '', 2),
...
INSERT
IGNORE INTO lieferant(adresse_id, lieferant_name, telefonnummer, email)
VALUES (9, 'BioFarm GmbH', '+49301234567', 'info@biofarm.de'),
       (10, 'FruchtExpress AG', '+49409876543', 'kontakt@fruchtexpress.de'),
       (2, 'GreenFoods KG.', '+492215554321', 'service@greenfoods.de'),
       (1, 'BioMasters GmbH', '+4961122334', 'support@biomasters.de');


INSERT
IGNORE INTO naehrstoffangabe (kalorien_pro_100g, proteine_pro_100g, kohlenhydrate_pro_100g, zucker_pro_100g, fett_pro_100g, gesaettigte_fettsaeuren_pro_100g, ballaststoffe_pro_100g, natrium_pro_100g)
VALUES (354, 12.5, 72, 1, 1, 0.2, 3, 0.006), -- Weizenmehl Tipo 00
       (881, 0, 0.2, 0, 100, 15, 0, 0.001), -- Olivenöl
       (83, 17, 1, 0.13, 1, 0.14, 7, 0.2), -- Hefe
       (405, 0, 100, 100, 0, 0, 0, 0), -- Zucker
       (0, 0, 0, 0, 0, 0, 0, 99.00), -- Salz
...
INSERT
IGNORE INTO ZUTAT(lieferant_id, naehrstoffangabe_id, bezeichnung, bestand, nettopreis, co2_aequivalent_pro_kg)
VALUES (2, 1, 'Weizenmehl Tipo 00', 500.00, 1.20, 0.7500),
       (1, 2, 'Olivenöl', 200.00, 3.50, 3.2500),
       ...
       (2, 14, 'Käse', 200.00, 4.00, 7.2000),
       (4, 15, 'Eier', 120.00, 2.80, 3),
       (3, 16, 'Ketchup', 500.00, 1.70, 1.2000),
       (2, 17, 'Senf', 50.00, 1.50, 0.5000),
       (4, 18, 'Naturjoghurt', 150.00, 1.10, 0.2000),
       (1, 19, 'Hackfleisch Rind', 300.00, 4.50, 21.7000),
       (3, 20, 'Schmelzkäse', 200.00, 3.00, 7.2000),
       ...
       (2, 27, 'Butter', 250.00, 3.60, 11.5000),
       (3, 28, 'Karotte', 150.00, 1.20, 0.2200),
       (4, 29, 'Vollkornmehl', 500.00, 1.80, 0.6500),
       (2, 30, 'Hähnchenbrust', 200.00, 5.00, 5.5000),
       ...
       (4, 54, 'Lachs (gegrillt)', 200.00, 7.50, 6.2000),
       (1, 55, 'Rindfleisch', 250.00, 6.00, 21.7000),
       ...
       (3, 60, 'Lammfleisch', 250.00, 6.50, 15.5000),
       (4, 61, 'Tofu', 200.00, 2.80, 1.0000),
       ...
       (4, 68, 'Thunfisch', 150.00, 5.50, 6.7000);


INSERT
IGNORE INTO beschraenkung(beschraenkung_typ)
VALUES ('Glutenunverträglichkeit'),
       ('Laktoseintoleranz'),
       ('Milcheiweißallergie'),
       ('Eiallergie'),
       ('Nussallergie'),
...
INSERT
IGNORE INTO ernaehrungskategorie(ernaehrungskategorie_typ)
VALUES ('Carnevor'),
       ('Omnivor'),
       ('Pescetarisch'),
       ('Vegetarisch'),
...
INSERT
IGNORE INTO zutat_beschraenkung (beschraenkung_id, zutat_id)
VALUES (1, 1),
       (9, 1),
       (2, 4),
       (3, 4),
...
INSERT
IGNORE INTO kunde (adresse_id, vorname, nachname, geburtsdatum, telefonnummer, email)
VALUES (4, 'Anna', 'Schneider', '1990-05-12', '+491711234567', 'anna.schneider@gmail.com'),
       (7, 'Ben', 'Müller', '1985-11-03', '+4915778889999', 'ben.mueller@web.de'),
       (5, 'Clara', 'Meier', '1994-03-27', '+491735551234', 'clara.meier@gmx.de'),
       (3, 'David', 'Fischer', '1982-09-14', '+491791234567', 'david.fischer@t-online.de'),
       (6, 'Eva', 'Weber', '1998-12-01', '+491511334455', 'eva.weber@outlook.de'),
       (8, 'Felix', 'Wagner', '1979-02-19', '+491761112222', 'felix.wagner@hotmail.de'),
       (3, 'Greta', 'Becker', '1992-07-05', '+491609998877', 'greta.becker@yahoo.de'),
       (4, 'Hannah', 'Hoffmann', '1987-08-20', '+491724445566', 'hannah.hoffmann@gmail.com'),
       (5, 'Isabel', 'Richter', '1996-10-11', '+491576662211', 'isabel.richter@web.de'),
       (7, 'Jonas', 'Klein', '1989-04-06', '+491797776655', 'jonas.klein@t-online.de'),
       (6, 'Klara', 'Wolf', '1993-06-30', '+491784443322', 'klara.wolf@outlook.de'),
       (8, 'Leon', 'Neumann', '1984-01-23', '+491599990000', 'leon.neumann@gmx.de'),
       (4, 'Mia', 'Schröder', '1997-11-08', '+491736665544', 'mia.schroeder@yahoo.de'),
       (5, 'Noah', 'Hartmann', '1991-03-15', '+491751112233', 'noah.hartmann@t-online.de'),
       (7, 'Olivia', 'Krüger', '1980-07-19', '+491665554411', 'olivia.krueger@gmail.com'),
       (6, 'Paul', 'Schulte', '1995-05-02', '+491732221111', 'paul.schulte@web.de'),
       (6, 'Rosa', 'Schulte', '1996-04-30', '+491732221341', 'rosa.schulte@web.de');


INSERT
IGNORE INTO bestellung (kunde_id, gesamtpreis, bestelldatum)
VALUES (1, 24.99, '2024-01-15'),
       (2, 57.20, '2024-01-20'),
       (3, 35.75, '2024-02-01'),
       (1, 80.10, '2024-02-10'),
       (5, 45.60, '2024-03-05'),
...
INSERT
IGNORE INTO zutat_ernaehrungskategorie (ernaehrungskategorie_id, zutat_id)
VALUES (1, 19),
       (2, 19),
       (1, 30),
       (2, 30),
...
INSERT
IGNORE INTO rezept (titel, beschreibung, zubereitung, zubereitungszeit_min, portionen)
VALUES ('Gefüllte Paprika mit Hackfleisch', 'Low-Carb-Abendessen mit viel Protein und Gemüse', 'Paprika halbieren, mit gewürztem Hackfleisch füllen und im Ofen backen.', 45, 2) ,
       ...
       ('Pizza mit Hackfleisch, Salami und Mozzarella', 'Klassische Pizza mit Fleischbelag', 'Teig ausrollen, belegen und im Ofen backen.', 55, 2);


INSERT
IGNORE INTO rezept_zutat (rezept_id, zutat_id, menge, einheit)
VALUES (1, 19, 300.00, 'g'), 
       (1, 38, 200.00, 'g'), 
       (1, 2, 20.00, 'ml'), 
       (1, 21, 5.00, 'g'), 
       (1, 5, 5.00, 'g'), 
...
INSERT
IGNORE INTO REZEPT_BESTELLUNG (bestellung_id, rezept_id, menge)
VALUES (1, 1, 2), -- Bestellung 1 enthält 2x "Gefüllte Paprika mit Hackfleisch"
