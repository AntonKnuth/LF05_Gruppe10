...
CREATE DATABASE bio_fresh;
   -- DEFAULT CHARACTER SET UTF8MB4 -- Wird gesagt, es ist schön wenn man es drin hat, ist vlt. aber ein bisschen zu viel.
	-- DEFAULT COLLATE utf8mb4_unicode_ci; -- Wird gesagt, es ist schön wenn man es drin hat, ist vlt. aber ein bisschen zu viel.
USE bio_fresh;
...
CREATE TABLE adresse (
	...
	ort_id INT NOT NULL,
	land CHAR(2) NOT NULL DEFAULT 'DE' COMMENT 'ISO 3166-1 Alpha-2'
);
